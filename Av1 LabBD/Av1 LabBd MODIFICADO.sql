...
BEGIN
	...
	-- PRECISA SETAR NOTA POR NOTA ENTÃO NÃO VAI DAR PRA USAR UMA SÓ VARIAVEL @nota
	-- PRECISA SETAR OS VALORES PRA TABELA ESCOLA?
	-- @total_de_pontos NA ESCOLA SÃO OS PONTOS FINAIS CONSIDERANDO MINIMO E MAXIMO?
